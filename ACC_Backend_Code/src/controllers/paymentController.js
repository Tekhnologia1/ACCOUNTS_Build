...
const createPaymentHandler = async (req, res) => {
  try {
    ...
    const { from_gl_id, to_gl_id, amount, from_firm_id, to_firm_id } = req.body;
    ...
    try {
      const transactionId = await createPayment(from_gl_id, to_gl_id, from_firm_id, to_firm_id, user_id, amount);
